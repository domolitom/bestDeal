...
#
# HOWTO: Copy to .claude/hooks/session-start.sh, chmod +x.
# Replace bd calls with your tracker's CLI if you use something else.
#
...
if ! command -v bd &>/dev/null; then
  echo "beads CLI (bd) not found. Install: https://github.com/steveyegge/beads"
  exit 0
fi

# Warn about uncommitted changes in main checkout
...
# Knowledge base — show count and most-recent entries
